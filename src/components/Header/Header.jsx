...
import AvatarImg from "../../assets/img/img-avatar-sample1.png";
      ...
      <div className="container-fluid">
        ...
        >
          ...
          <option data-content="<img src='./img/img-nike2.png'> Nike Store, Andersen Center 83b, West 82nd Street, San Francisco, CA">
            Nike Store, Andersen Center 83b, West 82nd Street, San Francisco, CA
          </option>
        </select>
              ...
              <div className="call-recording">
                ...
                <div className="toggle">
                  <input
                    ...
                    id="call-recording"
                  />
                  <label className="tgl-btn" htmlFor="call-recording"></label>
                </div>
              </div>
            ...
            >
              <div className="avatar">
                <div className="avatar_img">
                  <img src={AvatarImg} alt="Avatar Name" />
                </div>
              </div>
            </a>
            <div className="dropdown-menu dropdown-menu-right">
